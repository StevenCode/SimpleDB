...
/**
 * The interface will be implemented by each simpledb.query scan.
...
public interface Scan {
   ...
   /**
    * Positions the scan before its first simpledb.record.
    */
   public void     beforeFirst();
   
   /**
    * Moves the scan to the next simpledb.record.
   ...
   /**
    * Returns the value of the specified field in the current simpledb.record.
    ...
    * @param fldname the name of the field
    * @return the field's integer value in the current simpledb.record
    */
    ...
    * in the current simpledb.record.
    * @param fldname the name of the field
    * @return the field's string value in the current simpledb.record
    */
